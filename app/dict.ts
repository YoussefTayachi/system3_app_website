...
const de = {
  ...
  pillars: {
    ...
    items: [
      { id: "money", title: "Geld sparen", stat: "≈ 65 €", statLabel: "API-Kosten für 1.000 qualifizierte Leads", body: "BYOK statt Tool-Pauschale: ihr zahlt eure echten API-Kosten, keine Aufschläge. Kein Bundle aus mehreren Abos für 270–700 $/Monat." },
  ...
  why: {
    ...
    founderQuote: "„Die 33 Stunden gesparte Recherchezeit weiter oben auf dieser Seite sind aus unserer eigenen Akquise, nicht aus einer Fallstudie. Wir bauen Frostbreaker für das Problem, das wir selbst jeden Tag lösen mussten.“",
  ...
  contactPage: {
    ...
    bio: "Ich habe Frostbreaker gebaut, weil ich selbst Kaltakquise für Agenturen gemacht habe und jedes Mal zwischen vier Tools hin- und herexportiert habe, meistens für Ergebnisse, die nicht besser waren, als wenn ich einfach eine Person direkt gefunden hätte. Wenn du Fragen zum Produkt, zu Preisen oder zu eurem konkreten Use Case hast, meld dich einfach direkt.",
    emailLabel: "E-Mail",
    phoneLabel: "Telefon",
    calendlyLabel: "15 Minuten Call buchen",
  ...
  startPage: {
    ...
    finalHeading: "15 Minuten, wir zeigen es live an eurer eigenen Nische",
...
const en: typeof de = {
  ...
  heroStats: [
    { value: "≈ 33 hrs", label: "manual research saved, per search" },
    { value: "$2.75", label: "actual API cost for that" },
  ...
  pillars: {
    ...
    items: [
      { id: "money", title: "Save money", stat: "≈ €65", statLabel: "API cost for 1,000 qualified leads", body: "BYOK instead of a tool flat rate: you pay your actual API costs, no markups. No bundle of several subscriptions for $270–700/month." },
  ...
  why: {
    ...
    founderQuote: "\"The 33 hours of saved research time mentioned earlier on this page comes from our own outreach, not a case study. We're building Frostbreaker for the problem we had to solve ourselves every day.\"",
    founderName: "Youssef Tayachi",
  ...
  contactPage: {
    ...
    bio: "I built Frostbreaker because I ran cold outreach for agencies myself and kept exporting back and forth between four tools every time, usually for results no better than if I'd just found one person directly. If you have questions about the product, pricing, or your specific use case, just reach out.",
    emailLabel: "Email",
    phoneLabel: "Phone",
    calendlyLabel: "Book a 15-minute call",
  ...
  startPage: {
    ...
    finalHeading: "15 minutes, we'll show it live for your own niche",
